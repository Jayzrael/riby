...
const Footer = () => {
  ...
  <div className='foot'>
      <footer>
        ...
        <a href="tel: 01-2914247"><h3 className='num'> 01-2914247 </h3></a>
        <a href="tel: 08092222109"><h3 className='num1'> 08092222109 </h3></a>
        <img src="/mail.png" alt="" className='mole' />
        <a href="mailto:info@riby.me"><h3 className='mail'>info@riby.me</h3></a>
        <h3 className="follow">Follow Us: </h3>
         <a href="https://web.facebook.com/ribyhq/"><img src="/book.png" alt="" className="book" /></a>
        ...
        <a href="https://twitter.com/riby_hq?t=7CylrG781oG-LCKYhG0s0Q&s=09"><img src="/tweet.png" alt="" className="tweet" /></a>
