  ...
  return (
    <>
      <div className="marze">
        ...
        <div className="small">
          <h6>
            A group-based digital platform focused on enabling access to collective growth for 63
            million banked and unbanked Nigerians. Building affordable and accessible digital
            platform to promote collective growth.
          </h6>
        </div>
        <div>
        ...
        <div className="box1">
          ...
          <p className="smart">
            We encourage individual/group regular savings and contribution from members at various
            frequency best suited for them. Daily, weekly or monthly depending on their income
          </p>
        </div>
        <div className="box2">
          ...
          <h1>Borrow Easily</h1>
          <p className="smart">
            We connect Individuals, cooperatives and savings group members to external funding and
            loan packages outside their individual or group savings to support their various
            businesses.{" "}
          </p>
        </div>
        <div className="box3">
          ...
          <p className="smart">
            Investment plans and options are available for savings made by Individuals, cooperatives
            and groups. Put your savings to work and earn awesome returns.
          </p>
        </div>
      </div>
        ...
        <section className="lady">
          ...
          <div className="block1">
            ...
            <p>
              ...
              Cooperatives, Savings Group and Associations.
            </p>
            <h5>
              <Link to="/" className="lm-link">
                Learn More
              </Link>
            </h5>
          ...
          <div className="block2">
            ...
            <p>
              ...
              location or community. This is aimed at providing more value and service offering to
              boost revenue generation for the agents in addition to cooperative services being
              offered to the cooperatives and the general public..{" "}
            </p>
            <h5>
              <Link to="/" className="lm-link">
                Learn More
      ...
      <div className="sct4">
        ...
        <div className="marq">
          <Marquee className="marq1" behavior="scroll" direction="left" speed={40}>
            ...
            <img
              src="/partners/I8+id46_bf9Gs+UsjHIbe5y8lBTCg6S2ZQOWTLhYA72Clto4uVRgHDoBL749RVJXYpUxoOTEcPLVlVNgc7PFv1Jt+srNJHE+MaL6AjDeWJJ38OvLd16G91C3IU6wrTAa+5BqAwlhDG_Knwy98583X50IdZkAFs1D8Du2MvYDdrJqcbWc+xZ_WRsOZIAOsfkEsfUizIMccgZzpnzdPl67A4+F_L1.jpg"
              alt=""
            />
