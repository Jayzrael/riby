  ...
  return (
    <>
      <div className="abt-container">
        ...
        <AboutpageSection1 heading="Who We Are" text1="Riby is a digital and financial services company and is one of Nigeria’s foremost digital platforms providers for Cooperatives, Informal Savings Groups, Micro & Small-Scale Enterprises, and Trade Groups." text2="We assist individuals in economy clusters, SMEs, Cooperatives, and Trade Groups to access financial services through our digital platforms." />
        ...
        <div className="our-vision">
          <h1>OurVision</h1>
          <p>Is to enable access to collective growth
          </p>
        </div>
